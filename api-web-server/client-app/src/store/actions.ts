...
export type ActionEditPatient = { type: string, patientCopy: PatientVM, fieldNameId: number, newValue: FieldValue };
...
export function edit(patientCopy: PatientVM, fieldNameId: number, newValue: FieldValue): ActionEditPatient {
    return {
